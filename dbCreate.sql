...
CREATE TABLE `Users` (
  ...
  `interestedIn` VARCHAR(200) NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `userEducation` (
  ...
  `userId` TINYINT NULL DEFAULT NULL,
  `concentration` VARCHAR(200) NULL DEFAULT NULL,
...
CREATE TABLE `questions` (
  `id` TINYINT NOT NULL AUTO_INCREMENT DEFAULT NULL,
  `question` VARCHAR(200) NOT NULL DEFAULT 'NULL',
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `answers` (
  `id` TINYINT NOT NULL AUTO_INCREMENT DEFAULT NULL,
  `answer` VARCHAR(200) NOT NULL DEFAULT 'NULL',
  PRIMARY KEY (`id`)
);
